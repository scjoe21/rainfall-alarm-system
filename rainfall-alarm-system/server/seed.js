...
async function seed() {
  ...
  // ====== 읍면동 시드 ======
  const emds = [
    // 종로구 (EMD 코드: GeoJSON adm_cd2 기준, 5개 통합 구역)
    [10001,101,'1111051500','청운효자동·부암동'],
    [10002,101,'1111058000','교남동·사직동·무악동'],
    [10003,101,'1111054000','삼청동·가회동·혜화동'],
    [10004,101,'1111056000','평창동'],
    [10005,101,'1111061500','종로1·2·3·4가동 외'],
    // 강남구 (EMD 코드: GeoJSON adm_cd2 기준, 5개 통합 구역)
    [20001,123,'1168051000','신사동·논현1동·압구정동'],
    [20002,123,'1168053100','논현2·청담·삼성2·역삼1동'],
    [20003,123,'1168058000','삼성1동'],
    [20004,123,'1168060000','대치·역삼·도곡·개포동'],
    [20005,123,'1168075000','수서·세곡·일원동'],
    // 해운대구 (EMD 코드: GeoJSON adm_cd2 기준, 4개 통합 구역)
    [30001,209,'2635052500','우3동'],
    [30002,209,'2635053000','중1동·우1동·중2동·좌1동·좌3동'],
    [30003,209,'2635056000','송정동·좌2동·좌4동'],
    [30004,209,'2635065000','재송·우2동·반여·반송동'],
    // 세종 조치원읍 (EMD 코드: GeoJSON adm_cd2 기준)
    [40001,801,'3611025000','조치원읍'],[40002,802,'3611031000','연기면'],
    [40003,803,'3611032000','연동면'],[40004,804,'3611033000','부강면'],
    [40005,805,'3611034000','금남면'],[40006,806,'3611035000','장군면'],
    [40007,807,'3611036000','연서면'],[40008,808,'3611037000','전의면'],
    [40009,809,'3611038000','전동면'],[40010,810,'3611039000','소정면'],
    [40011,811,'3611051000','한솔동'],[40012,812,'3611051500','새롬동'],
    [40013,813,'3611052000','도담동'],[40014,814,'3611053000','아름동'],
    [40015,815,'3611054000','종촌동'],[40016,816,'3611055000','고운동'],
    [40017,817,'3611056000','보람동'],[40018,818,'3611057000','대평동'],
    [40019,819,'3611055500','소담동'],[40020,820,'3611055600','반곡동'],
    // 세종 신규 읍면동
    [40021,821,'3611058000','다정동'],[40022,822,'3611052500','해밀동'],
    [40023,823,'3611051800','나성동'],[40024,824,'3611052300','어진동'],
    // 제주시 (EMD 코드: GeoJSON adm_cd2 기준, 4개 통합 구역)
    [50001,1701,'5011051000','제주시 중부'],
    [50002,1701,'5011031000','한경면·한림읍'],
    [50003,1701,'5011060000','화북동'],
    [50004,1701,'5011061000','삼양·봉개동 외'],
    // 광산구 (광주, EMD 코드: GeoJSON adm_cd2 기준, 4개 통합 구역)
    [60001,505,'2920051500','송정1동·도산동·신흥동·동곡동'],
    [60002,505,'2920052500','송정2동·어룡·우산·평동·삼도동'],
    [60003,505,'2920064000','하남·월곡·운남·수완·임곡·본량동'],
    [60004,505,'2920070000','신창·비아·첨단·신가동'],
    // 서귀포시 (EMD 코드: GeoJSON adm_cd2 기준, 3개 통합 구역)
    [50101,1702,'5013052000','서귀포시 중부'],
    [50102,1702,'5013025900','성산읍·표선면'],
    [50103,1702,'5013062000','예래동·중문동·대정읍'],
  ];
  ...
  const stations = [
    // 종로구
    [1,'401','서울',37.5714,126.9658,10005],    // 종로1·2·3·4가동 외
    [2,'509','북악산',37.5944,126.9783,10002],  // 교남동·사직동·무악동
    [3,'510','청운동',37.5870,126.9668,10001],  // 청운효자동·부암동
    [4,'511','삼청동',37.5870,126.9830,10003],  // 삼청동·가회동·혜화동
    [5,'512','평창동',37.6100,126.9750,10004],  // 평창동
    // 강남구
    [10,'400','강남',37.5133,127.0420,20002],   // 논현2·청담·삼성2·역삼1동
    [11,'520','신사동',37.5237,127.0230,20001], // 신사동·논현1동·압구정동
    [12,'521','삼성동',37.5105,127.0600,20003], // 삼성1동
    [13,'522','대치동',37.4940,127.0570,20004], // 대치·역삼·도곡·개포동
    [14,'523','수서동',37.4870,127.1010,20005], // 수서·세곡·일원동
    // 해운대구
    [20,'159','부산',35.1046,129.0319,30002],   // 중1동·우1동·중2동·좌1동·좌3동
    [21,'959','해운대',35.1630,129.1640,30001], // 우3동
    [22,'960','송정',35.1785,129.2000,30003],   // 송정동·좌2동·좌4동
    [23,'961','반여동',35.1840,129.1310,30004], // 재송·우2동·반여·반송동
    // 세종 (stn_id 중복 허용 — 1개 물리 관측소가 여러 읍면동을 담당)
    // 신도심 14개 읍면동: 세종고운(494, 36.531°N, 127.240°E) → 신도심 중앙 관측소
    [30,'494','세종고운',36.53083,127.24028,40011],   // 한솔동
    [31,'861','조치원',36.6010,127.0010,40001], // 조치원읍
    [32,'862','연기',36.5560,127.0340,40002],   // 연기면
    [33,'863','부강',36.5270,127.1440,40004],   // 부강면
    [34,'864','금남',36.4700,127.0800,40005],   // 금남면
    [35,'862','연기',36.5560,127.0340,40003],   // 연동면
    [36,'864','금남',36.4700,127.0800,40006],   // 장군면
    [37,'862','연기',36.5560,127.0340,40007],   // 연서면
    [38,'861','조치원',36.6010,127.0010,40008], // 전의면
    [39,'861','조치원',36.6010,127.0010,40009], // 전동면
    [44,'861','조치원',36.6010,127.0010,40010], // 소정면
    [45,'494','세종고운',36.53083,127.24028,40012],   // 새롬동
    [46,'494','세종고운',36.53083,127.24028,40013],   // 도담동
    [47,'494','세종고운',36.53083,127.24028,40014],   // 아름동
    [48,'494','세종고운',36.53083,127.24028,40015],   // 종촌동
    [49,'494','세종고운',36.53083,127.24028,40016],   // 고운동
    [53,'494','세종고운',36.53083,127.24028,40017],   // 보람동
    [54,'494','세종고운',36.53083,127.24028,40018],   // 대평동
    [55,'494','세종고운',36.53083,127.24028,40019],   // 소담동
    [56,'494','세종고운',36.53083,127.24028,40020],   // 반곡동
    [57,'494','세종고운',36.53083,127.24028,40021],   // 다정동
    [58,'494','세종고운',36.53083,127.24028,40022],   // 해밀동
    [59,'494','세종고운',36.53083,127.24028,40023],   // 나성동
    [66,'494','세종고운',36.53083,127.24028,40024],   // 어진동
    // 광산구
    [60,'156','광주',35.1731,126.8915,60003],   // 하남·월곡·운남·수완·임곡·본량동
    [61,'723','송정',35.1390,126.7920,60001],   // 송정1동·도산동·신흥동·동곡동
    [62,'724','첨단',35.1930,126.8480,60004],   // 신창·비아·첨단·신가동
    [64,'726','평동',35.1280,126.8100,60002],   // 송정2동·어룡·우산·평동·삼도동
    // 제주시
    [40,'184','제주',33.5140,126.5298,50001],   // 제주시 중부
    [41,'185','고산',33.2940,126.1628,50002],   // 한경면·한림읍
    [42,'786','화북',33.5250,126.5700,50003],   // 화북동
    [43,'787','삼양',33.5280,126.5900,50004],   // 삼양·봉개동 외
    // 서귀포시
    [50,'189','서귀포',33.2461,126.5653,50101], // 서귀포시 중부
    [51,'188','성산',33.3870,126.8800,50102],   // 성산읍·표선면
    [52,'793','중문',33.2540,126.4120,50103],   // 예래동·중문동·대정읍
  ];
